import { IcoRules, IcoTarget, IcoRematch, IcoCardType, IcoAttack, IcoOverflow, IcoHint } from '../icons';
  ...
  return (
    <div className="overlay" onClick={onClose}>
      <div className="panel rules-modal" onClick={(e) => e.stopPropagation()}>
        <h2><IcoRules className="ic" /> Como jogar</h2>
        <div className="rules-grid">
          <section>
            <h4><IcoTarget className="ic" /> Objetivo</h4>
            <p>Reduza a vida do oponente de <b>30 a 0</b>. Partidas duram ~10 minutos.</p>
          </section>
          <section>
            <h4><IcoRematch className="ic" /> Seu turno</h4>
            <p>
          ...
          <section>
            <h4><IcoCardType className="ic" /> Tipos de carta</h4>
            <p>
          ...
          <section>
            <h4><IcoAttack className="ic" /> Combate</h4>
            <p>
          ...
          <section>
            <h4><IcoOverflow className="ic" /> Dano excedente</h4>
            <p>
          ...
          <section>
            <h4><IcoHint className="ic" /> Dicas</h4>
            <p>
